...
export class AddProjectPage extends GeneralPage {
    ...
    protected debitCreditByRowStr =
        "//div[.='{0}']/ancestor::div[@role='row']//select[@id='project-details-i-debit-credit-group-id']";
    ...
    protected unitPriceByRowStr =
        "//div[.='{0}']/ancestor::div[@role='row']//input[@id='project-details-i-unit-price']";
    ...
    protected countPMByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-0-count']";
    protected countLeaderByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-1-count']";
    protected countTesterByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-2-count']";
    protected countDesignerByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-3-count']";
    protected countExpertByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-4-count']";
    protected countReserve1ByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-5-count']";
    protected countReserve2ByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-6-count']";
    protected countReserve3ByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-7-count']";
    protected countReserve4ByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-8-count']";
    protected countReserve5ByRowStr =
        "//div[@id='project-resources']//div[@class='tabulator-table']/div[{0}]//input[@id='project-resources-i-project-resource-headcounts-9-count']";
    //#endregion
    ...
    public async searchDepartment(department: string): Promise<void> {
        ...
        await this.selectSearchResult(department, SearchResultColumn.REP_NAME);
    }
