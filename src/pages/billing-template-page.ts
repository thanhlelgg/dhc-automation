...
export class BillingTemplatePage extends GeneralPage {
    protected pageUrl = `${Constants.BMS_BASE_URL}/billings/template-file-index`;
    @locator
    protected templateTable = '//table';
    protected tableHelper = new TableHelper(this.templateTable);
    protected tableColumnName = Constants.translator.columnName.billingTemplate;
...
export default new BillingTemplatePage();
